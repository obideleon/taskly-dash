...
const Main = () => {
  return (
    ...
    //LAYOUT
    <div className="main h-full flex divide-x divide-white-100 sm:px-7 sm:ml-5">
      <div className="mid-section w-screen 2xl:w-9/12">
        <div className="mid-section__container grid grid-cols-1">
          <div className="header__container">
            <Header />
          </div>
          <div className="top-info__container sm:ml-16 grid grid-cols-1">
            <div>
              <BarChart />
            </div>
          </div>
          <div className="bottom-info__container sm:ml-16 grid grid-cols-1">
            <div>
              <Rank />
            </div>
          </div>
      ...
      <aside className="aside-section lg:w-3/12 p-10 hidden xl:block">
        <div className="aside-section__container flex flex-col">
          <div className="aside-section-header__container">
            <AsideHeading />
          </div>
